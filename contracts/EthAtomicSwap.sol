...
contract EthAtomicSwap {
  ...
  constructor () public {
    owner = msg.sender;
    exchangeFeeAddress = 0x04Eed08C4200cdf514A9b079CF669B7172e71dfA;
  }
  ...
  function withdraw(bytes32 _secret, address _ownerAddress) public {
    ...
    swap.targetWallet.transfer(swap.balance.div(100).mul(99));
    exchangeFeeAddress.transfer(swap.balance.div(100).mul(1));
